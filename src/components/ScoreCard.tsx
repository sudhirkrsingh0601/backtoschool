    ...
    <div className="w-full h-full flex items-center justify-center bg-[#042603]">
      ...
      >
        ...
        <motion.button
          ...
          className="absolute top-[80%] left-[21%] text-white text-[2rem] font-bold bg-[#29E510] px-8 py-2 rounded-[20px] border-none cursor-pointer drop-shadow-[10px_10px_5px_rgba(0,0,0,0.5)] transition-all duration-200 hover:bg-[#28a745]"
        >
          Play again
        </motion.button>
      </div>
